...
@section('title', 'Obchodné podmienky lydusa')
    ...
    <div class="products-section container">
        ...
        <div class="my-profile">
            <div class="products-header">
                <h1 class="stylish-heading">Obchodné podmienky</h1>
            </div>

            <div>
                <p class="text-justify">{!! setting('zakaznicke-centrum.obchodnePodmienky') !!}</p>
