...
@section('title', 'Spracovanie osobných údajov')
    ...
    <div class="products-section container">
        ...
        <div class="my-profile">
            <div class="products-header">
                <h1 class="stylish-heading">Spracovanie osobných údajov</h1>
            </div>

            <div>
                <p class="text-justify">{!! setting('zakaznicke-centrum.spracovanieOU') !!}</p>
