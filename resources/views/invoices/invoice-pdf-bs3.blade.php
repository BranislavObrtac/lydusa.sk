    ...
    <div class="row">
        <div class="col-lg-10 col-lg-offset-1" style="margin-top:20px; text-align: right">
            <div class="btn-group mb-4">
                <a href="/faktura-pdf-bs3-download" class="btn btn-success">Save as PDF</a>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row mb-4" style="margin-left: 5px;">
                ...
                <table class="table" style="max-width: 73%; background-color: lightgrey">
                    <thead>
                    <tr>
            ...
            <br>
            <div class="row mb-8" style="margin-left: 5px;">
                <div class="col-sm-4" style="padding: 10px; ">
            ...
            <div>
                ...
                <img src="{{ public_path() . $image_path }}" style="height: 100px; margin-left: 90px;">

{{--
                <img src="/public/storage/lydusaLogo.png" style="height: 100px; margin-left: 90px;" alt="img">
--}}
